...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <Button class="greenbtns" >ADD NEW BOOK</Button>
            ...
            <div class="label">Branch:        <input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="BSIT"/>BSIT<div style="margin-left:80px"><input type="radio" name="branch" value="BSCS"/>BSCS<input type="radio" name="branch" value="BSSE"/>BSSE</div>
            </div>   
            ...
            <Button class="greenbtns" >ADD Person</Button>
            ...
            <Button class="greenbtns" >Student RECORD</Button>
            ...
            <Button class="greenbtns" >Issue Book Record</Button>
...
issue book -->
            ...
            <Button class="greenbtns" >ISSUE BOOK</Button>
...
<br>
            ...
            <Button class="greenbtns" >BOOK DETAIL</Button>
</br>
<?php
            $u=new data;
            $u->setconnection();
...
?>
            ...
            <Button class="greenbtns" >BOOK RECORD</Button>
            <?php
            $u=new data;
            $u->setconnection();
            $u->getbook();
